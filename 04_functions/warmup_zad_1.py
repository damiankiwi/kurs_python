# 1. Napisz funkcję, która pyta użytkownia o pary ksiązka + ocena i zapisuje je w programie.
# 2. Napisz funkcję, która zapyta o numer ksiązki i wyśietli tytuł wraz z oceną.
# 3. W prosty sposób obsłuż błąd uzytkownika - użytkownik zapyta o numer w bazie, który nie istenieje.
